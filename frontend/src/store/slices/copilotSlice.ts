...
const initialState: CopilotState = {
  chatHistory: {
    'assistant': [
      { role: 'agent', content: '🏭 Central RAG Copilot initialized. Select an asset or ask any maintenance questions.' }
    ]
  },
  assistantSessions: [],
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchAssistantHistory.fulfilled, (state, action) => {
        ...
        // Normalize messages to UI types
      ...
      .addCase(inquireAssistant.fulfilled, (state, action) => {
        ...
        // Remove typing indicator or any placeholder if needed
...
export const { addChatMessage, setAssistantSidebarOpen, setActiveAssistantSessionId, setAssistantMachineId, setExportProgress, resetExportProgress } = copilotSlice.actions;
