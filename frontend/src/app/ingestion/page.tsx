      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden group">
          ...
          <div className="space-y-6">
            ...
            <button 
              ...
              className="w-full bg-blue-600 hover:bg-blue-500 disabled:bg-slate-800 disabled:text-slate-500 text-white font-bold py-4 px-6 rounded-2xl transition-all flex items-center justify-center gap-3 shadow-xl shadow-blue-500/20 group cursor-pointer"
            >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-indigo-600/20 to-blue-600/20 border border-blue-500/20 rounded-3xl p-8">
            <h3 className="text-white font-bold mb-2">Multimodal Layout Parsing</h3>
            <p className="text-slate-400 text-sm leading-relaxed">
              Upon initializing manual ingestion, the backend extracts layout bounds using PyMuPDF and segment components via Gemini Vision and Mobile SAM models. Extracted figures and schematics are converted into vector chunks and stored securely inside Neon DB with pgvector capabilities.
            </p>
          </div>
        </div>
      </div>
