...
class KnowledgeAgent:
    """
    RAG Specialist Agent: Coordinates semantic retrievals and Gemini multi-modal synthesis.
    Implements 5 steering modes (Summary, ELI5 Bullet Clarifications, Safety JSON, Evaluator, and wizard).
    """
    def __init__(self):
    ...
    def query(self, query: str, manual_id: str, machine_id: str = None, mode: RAGMode = RAGMode.SUMMARY, chat_history: str = "") -> dict:
        ...
        try:
            try:
                ...
                print(f"❌ [KnowledgeAgent] DB Retrieval failed: {e}")
            finally:
                if db:
                    db.close()
            ...
            print(f"❌ [KnowledgeAgent] Formulation failed: {e}")
            raise e
    ...
    def _build_summary_prompt(self, manual_id: str, text_context: str, history_context: str, missing_manual: bool = False) -> str:
        ...
        return (
            ...
            "5. ONLY describe WHAT the problem likely is and WHY based on the technical context.\n"
    ...
    def _build_clarification_prompt(self, manual_id: str, step_text: str, text_context: str, image_references: list, missing_manual: bool = False) -> str:
        ...
        return (
            ...
            "5. IMAGE INCLUSION (MANDATORY): You MUST interleave relevant [IMAGE_N] tags within your bullet points. If diagrams are available, place them at the correct logical step.\n"
    ...
    def _build_conversational_wizard_prompt(self, manual_id: str, user_query: str, text_context: str, history_context: str, image_references: list, history: str, missing_manual: bool = False) -> str:
        ...
        return (
            ...
            "3. IMAGES (MANDATORY): You MUST interleave [IMAGE_N] tags (e.g. [IMAGE_0], [IMAGE_1]) directly into your steps at the EXACT point where the visual reference is most helpful.\n"
            "4. ADAPT: If they completed a step, provide the EXACT next step from the manual.\n"
